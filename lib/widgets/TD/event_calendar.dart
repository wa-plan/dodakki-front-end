                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                    borderRadius:
                                        BorderRadius.circular(8), // 이미지도 컨테이너처럼 둥글게
                                    child: Opacity(
                                      opacity: 0.2,
                                      child: Image.asset(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: currentWidth < 600 ? 28 : 30),
                                        GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              value[index].didHalf =
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              value[index].didAll = !value[index].didAll;
                                              value[index].didZero = false;
                                              value[index].didHalf = false;
                                            });
                                            String formattedDate =
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Container(
          ...
          height: currentWidth < 600 ? 200 : 270,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: currentWidth < 600 ? 15 : 19,
                              fontWeight: FontWeight.w600),
                        ),
                      ],
                    ),
