    ...
    body: jsonEncode({
      ...
      "messages": [
        ...
        },
        {
          "role": "user",
          "content":
              "장기 목표 달성을 위한 계획법 중에서 만다라트를 작성하려고 해. 최종목표가 '$coreGoal'(이)라고 할 때, 최종목표를 달성하기 위해 해야하는 세부목표 6가지를 9글자 이내로 추천해줘. 세부목표는 간결한 구나 단어어 형태이면 좋겠어. 예를 들어, 최종목표가 '뿌듯한 25-1 학교생활 보내기'라면 '스펙 쌓기', '자기관리하기','돈 많이 모으기', '다양한 사람 만나보기', '내가 뭘 좋아하는지 찾기' 등이 있을 것 같아. 추상적이기보다는 구체적인 내용이었으면 좋겠어. 20대 초중반인 열정이 넘치는 여자 대학생이 많이 공감할만한 내용으로 추천해줘. 답변으로는 너가 추천하는 6가지 항목만 작성해줘."
        }
      ],
      "max_tokens": 150,
      "temperature": 0.7,
