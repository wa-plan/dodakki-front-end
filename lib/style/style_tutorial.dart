...
//패딩
const tutorialPadding = EdgeInsets.fromLTRB(40, 65, 40, 20);
      ...
      children: List.generate(total, (index) {
        ...
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isCurrent ? mainRed : const Color(0xff515151),
...
class _MandalartOptionState extends State<MandalartOption> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: SizedBox(
        width: widget.currentWidth < 600 ? 330 : 450,
                    ...
                    children: [
                      Positioned(
                        ...
                        child: Icon(
                              ...
                              size: widget.currentWidth < 375 ? 13 : 18,
                              color: selectedIndex == index
                                  ? textColorDefiner(widget.color)
                                  : Color(0xff3B3B3B),
                            ),
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: selectedIndex == index
                                ? textColorDefiner(widget.color)
                                : Colors.white,
                            fontSize: widget.currentWidth < 375 ? 12 : 14,
                            fontWeight: FontWeight.w600,
                          ),
                        ),
                      ),
                  ...
                  child: Stack(
                    ...
                    children: [
                     ...
                     Image.asset(
                          ...
                          fit: BoxFit.fill,
                          scale: widget.currentWidth < 600 ? 1 : 2,
                        ),
